  ...
  <div class="app-container">
    ...
    <el-card class="box-card">
      ...
      <el-table :data="attributes">
        <el-table-column property="attribute" label="商品属性名称"/>
        <el-table-column property="value" label="商品属性值"/>
        <el-table-column align="center" label="操作" width="100" class-name="small-padding fixed-width">
          <template slot-scope="scope">
      ...
      <el-dialog :visible.sync="attributeVisiable" title="设置商品属性">
        <el-form ref="attributeForm" :model="attributeForm" status-icon label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
          <el-form-item label="商品属性名称" prop="attribute">
...
<script>
import { detailGoods, editGoods, listCat } from '@/api/goods'
