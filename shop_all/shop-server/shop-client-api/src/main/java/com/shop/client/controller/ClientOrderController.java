...
import com.shop.client.service.ClientOrderService;
...
public class ClientOrderController {
    private final Log logger = LogFactory.getLog(ClientOrderController.class);

    @Autowired
    private ClientOrderService wxOrderService;
