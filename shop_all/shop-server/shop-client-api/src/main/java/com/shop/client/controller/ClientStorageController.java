...
public class ClientStorageController {
    private final Log logger = LogFactory.getLog(ClientStorageController.class);
    ...
    public Object upload(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        ShopStorage storage = storageService.store(file.getInputStream(), file.getSize(), file.getContentType(), originalFilename);
    ...
    public ResponseEntity<Resource> fetch(@PathVariable String key) {
        ShopStorage shopStorage = shopStorageService.findByKey(key);
        if (key == null) {
        ...
        String type = shopStorage.getType();
