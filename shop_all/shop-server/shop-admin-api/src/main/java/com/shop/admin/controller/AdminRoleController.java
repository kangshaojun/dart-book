...
import com.shop.admin.vo.PermVo;
...
import com.shop.admin.util.Permission;
import com.shop.admin.util.PermissionUtil;
...
import static com.shop.admin.util.AdminResponseCode.ROLE_NAME_EXIST;
import static com.shop.admin.util.AdminResponseCode.ROLE_USER_EXIST;
...
public class AdminRoleController {
    ...
    public Object list(String name,
        ...
        List<ShopRole> roleList = roleService.querySelective(name, page, limit, sort, order);
        return ResponseUtil.okList(roleList);
    }

    @GetMapping("/options")
    public Object options() {
        List<ShopRole> roleList = roleService.queryAll();
    ...
    public Object read(@NotNull Integer id) {
        ShopRole role = roleService.findById(id);
        return ResponseUtil.ok(role);
    }


    private Object validate(ShopRole role) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody ShopRole role) {
    ...
    @PostMapping("/update")
    public Object update(@RequestBody ShopRole role) {
        Object error = validate(role);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody ShopRole role) {
        ...
        List<ShopAdmin> adminList = adminService.all();
    ...
    private List<PermVo> getSystemPermissions() {
        final String basicPackage = "com.shop.admin";
    ...
    public Object updatePermissions(@RequestBody String body) {
        ...
        for (String permission : permissions) {
            ...
            shopPermission.setRoleId(roleId);
            shopPermission.setPermission(permission);
            permissionService.add(shopPermission);
        }
        return ResponseUtil.ok();
    }
