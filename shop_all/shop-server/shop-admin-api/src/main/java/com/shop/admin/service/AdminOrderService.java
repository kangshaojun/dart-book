...
public class AdminOrderService {
    ...
    public Object list(Integer userId, String orderSn, List<Short> orderStatusArray,
        ...
        List<ShopOrder> orderList = orderService.querySelective(userId, orderSn, orderStatusArray, page, limit,
                sort, order);
    ...
    public Object detail(Integer id) {
        ...
        List<ShopOrderGoods> orderGoods = orderGoodsService.queryByOid(id);
