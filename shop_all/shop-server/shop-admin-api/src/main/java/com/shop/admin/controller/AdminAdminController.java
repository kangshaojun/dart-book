...
import com.shop.admin.service.LogHelper;
...
import static com.shop.admin.util.AdminResponseCode.*;
...
public class AdminAdminController {
    ...
    public Object list(String username,
        ...
        List<ShopAdmin> adminList = adminService.querySelective(username, page, limit, sort, order);
        return ResponseUtil.okList(adminList);
    }

    private Object validate(ShopAdmin admin) {
    ...
    @PostMapping("/create")
    public Object create(@RequestBody ShopAdmin admin) {
    ...
    public Object read(@NotNull Integer id) {
        ShopAdmin admin = adminService.findById(id);
        return ResponseUtil.ok(admin);
    }
    ...
    @PostMapping("/update")
    public Object update(@RequestBody ShopAdmin admin) {
        Object error = validate(admin);
        if (error != null) {
            return error;
        }
    ...
    @PostMapping("/delete")
    public Object delete(@RequestBody ShopAdmin admin) {
        Integer anotherAdminId = admin.getId();
        if (anotherAdminId == null) {
            return ResponseUtil.badArgument();
        }
        ...
        ShopAdmin currentAdmin = (ShopAdmin) currentUser.getPrincipal();
